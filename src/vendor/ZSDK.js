...
/**
 * It takes a URL as input and returns an object with the query parameters as keys and their values as
 * values
 * @param URL - The URL to parse. If not provided, the current URL is used.
 * @returns An object with the query parameters as keys and their values as values.
 */
...
/**
 * > If the app is registered and the message is coming from the authorized parent window and origin,
 * then return true. Otherwise, return an error
 * @param MEvent - The message event object.
